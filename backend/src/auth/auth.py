...
AUTH0_DOMAIN = '3fsnd.us.auth0.com'
ALGORITHMS = ['RS256']
API_AUDIENCE = 'cafe api'
...
@TODO implement verify_decode_jwt(token) method
    ...
    !!NOTE urlopen has a common certificate error described here:
     https://stackoverflow.com/questions/50236117/scraping
     -ssl-certificate-verify-failed-error-for-http-en-wikipedia-org
'''
